...
import elzero1 from "../../assets/project/elzero/page1.webp";
import elzero2 from "../../assets/project/elzero/page2.png";
import elzero3 from "../../assets/project/elzero/page3.png";
import elzero4 from "../../assets/project/elzero/page4.png";
import elzero5 from "../../assets/project/elzero/page5.png";
import specialdesign1 from "../../assets/project/specialdesign/page1.png";
import specialdesign2 from "../../assets/project/specialdesign/page2.png";
import specialdesign3 from "../../assets/project/specialdesign/page3.png";
import specialdesign4 from "../../assets/project/specialdesign/page4.png";
import kasper1 from "../../assets/project/kasper/page1.png";
import kasper2 from "../../assets/project/kasper/page2.png";
import kasper3 from "../../assets/project/kasper/page3.png";
import kasper4 from "../../assets/project/kasper/page4.png";
...
export const data = [
  ...
  },
  {
    id: 12,
    title: "Elzero",
    summary: "A responsive template created using only HTML,CSS,and JavaScript",
    Language: ["WebDesign", "JavaScript"],
    img: [elzero1, elzero2, elzero3, elzero4, elzero5],
    Description:
    ...
    github: "https://github.com/hamzaabduljalil/Hamza.project3.github.io",
    hosting: "https://hamzaabduljalil.github.io/Hamza.project3.github.io/",
  },
  {
    id: 13,
    ...
    summary: "A responsive template created using only HTML,CSS,and JavaScript",
    Language: ["WebDesign", "JavaScript"],
    img: [specialdesign1, specialdesign2, specialdesign3, specialdesign4],
    Description:
      'The "Special Design" website is a creative agency portfolio that showcases the company\'s services, skills, and projects. The site features sections such as "About Us," "Our Skills," "Our Gallery," "Timeline," "Features," and "Testimonials." It highlights expertise in areas like HTML, CSS, JavaScript, Python, PHP, and MySQL. The gallery displays various images, and the timeline provides insights into the company\'s history and milestones. Additionally, the "Features" section outlines services including Development, Marketing, Hosting, Mobile Development, Cloud and Servers, and SEO. Client testimonials are also presented, reflecting positive feedback about the company\'s products and services. The website is designed with customizable options, allowing users to select colors, randomize backgrounds, and toggle bullet points. It concludes with a "Contact Us" section, inviting visitors to reach out for more information.',
    github: "https://github.com/hamzaabduljalil/Hamza.SpecialDesign.github.io",
    hosting: "https://hamzaabduljalil.github.io/Hamza.SpecialDesign.github.io/",
  },
  // {
  //   id: 14,
  //   title: "Kasper",
  //   summary: "A responsive template created using only HTML,CSS,and JavaScript",
  //   Language: ["WebDesign", "JavaScript"],
  //   img: [kasper1, kasper2, kasper3, kasper4],
  //   Description:
  //     'The "Kasper" website is a modern and responsive template designed to showcase creative services and portfolios. The site features multiple sections, including "Home," "Services," "Portfolio," "About," "Pricing," and "Contact." The "Services" section outlines various offerings, while the "Portfolio" displays a range of projects with categories like App, Photo, Web, and Print. The "About Us" section provides insights into the company\'s achievements, and the "Pricing" section details different service packages. The website emphasizes a clean design, responsive layout, and browser compatibility. It also includes a "Contact Us" section for inquiries.',
  //   github: "https://github.com/hamzaabduljalil/Hamza.Kasper.github.io",
  //   hosting: "https://hamzaabduljalil.github.io/Hamza.Kasper.github.io/",
  // },
];
